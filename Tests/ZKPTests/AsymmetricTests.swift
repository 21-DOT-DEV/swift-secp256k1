...
struct AsymmetricTestSuite {
    ...
    func compressedKeypairImplementationWithRaw() throws {
    ...
    func compressedPublicKey() throws {
    ...
    func uncompressedPublicKey() throws {
    ...
    func uncompressedPublicKeyWithKey() throws {
    ...
    func keyFormatConversion() throws {
