...
protocol APITestingType {
    func uncompressedKeypairCreation()
    func compressedKeypairCreation()
    func ecdhBindings()
    ...
    func sha256()
    func sha32BytesDigest()
    func signing()
    func recoverySigning()
    func publicKeyRecovery()
    func schnorrSigning()
    func verifying()
    func schnorrVerifyingPre()
    func schnorrVerifying()
    func verifyingDER()
    func privateKey()
